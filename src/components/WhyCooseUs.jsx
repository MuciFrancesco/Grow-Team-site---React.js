            ...
            <div className="why-couse-us-text">
               ...
               <p>{textLorem}</p>
                <div className="why-couse-us-btn">
                    <Link onClick={OpenToTopPage} to="/about-us"><button className='btn-1'>Scopri chi siamo</button></Link>
                    <Link onClick={OpenToTopPage} to="/services"><button className='btn-2'>Esplora i nostri servizi</button></Link>
                </div>
            </div>
