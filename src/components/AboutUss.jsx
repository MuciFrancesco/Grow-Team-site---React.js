    ...
    <div className="about-uss">
      ...
      <div className="about-card">
        <div className="about-text">
          ...
          <p>
            Ipsum delectus excepturi hic quas praesentium aspernatur cupiditate
            animi ipsam magni! Quo, autem sequi similique aspernatur itaque sint
            temporibus. Impedit at totam voluptate.
          </p>
        </div>
